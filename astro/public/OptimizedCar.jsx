...
Command: npx gltfjsx@6.2.16 optimizedCar.glb —transform —simplify 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/optimizedCar.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, 0.212, -0.034]} rotation={[-1.571, 0, 0]}>
        <mesh geometry={nodes.body.geometry} material={materials.carpaint_metalic_white} position={[0, 1.493, -0.211]} rotation={[Math.PI / 2, Math.PI / 2, 0]} scale={0.001}>
          ...
          <mesh geometry={nodes.glass002.geometry} material={materials.glass_clear} />
          ...
          <mesh geometry={nodes.object.geometry} material={materials.mercemblem} />
      ...
      <group position={[-0.817, 0.352, -1.526]} rotation={[0.377, 0, 0]}>
        <mesh geometry={nodes.wheelBkR.geometry} material={materials.tire} position={[0.817, 0, -0.352]} rotation={[-Math.PI / 2, 1.571, 0]} scale={-0.001}>
      ...
      <group position={[0.803, 0.353, 1.627]} rotation={[0.377, 0, 0]}>
        <mesh geometry={nodes.wheelFtL.geometry} material={materials.tire} position={[-0.803, 3.153, -0.352]} rotation={[Math.PI / 2, Math.PI / 2, 0]} scale={0.001}>
          <mesh geometry={nodes.disk002.geometry} material={materials.metal_brush_cirular} />
          <mesh geometry={nodes.logo002.geometry} material={materials.chrome} />
          <mesh geometry={nodes.palstic.geometry} material={materials.plastic_shiny_black} />
          <mesh geometry={nodes.wheel002.geometry} material={materials.metal_rough_plus_rim} />
        </mesh>
      </group>
...
useGLTF.preload('/optimizedCar.glb')
